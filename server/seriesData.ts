...
export const PROVIDERS: StreamingProvider[] = [
  ...
  },
  {
    "id": "disney_plus",
    "name": "Disney+",
    "badgeColor": "bg-blue-800/20 text-blue-300 border-blue-500/30",
    "bgColor": "bg-[#113CCF]",
    "textColor": "text-white",
    "iconName": "Sparkles",
    "accentColor": "#113CCF"
...
export const INITIAL_SERIES_DATABASE: Series[] = [
  {
    ...
    "renewalBadgeText": "Season 2 Streamed on Apple TV+ • S3 in Works",
    "nextSeasonNumber": 3,
    "renewalNewsSummary": "Severance Season 2 concluded its major revelations; Season 3 is officially in active development.",
  ...
  },
  {
    ...
    "isNextWatch": true,
    "renewalState": "in_production",
    "renewalBadgeText": "Final Season 5 in Post-Production",
    "nextSeasonNumber": 5,
    "renewalNewsSummary": "The Duffer Brothers are wrapping post-production on the final season, featuring feature-film length episodes.",
    "cast": [
      {
  ...
  },
  {
    ...
    "isNextWatch": true,
    "renewalState": "renewed",
    "renewalBadgeText": "Season 2 Streamed on Max • Season 3 Greenlit",
    "nextSeasonNumber": 3,
    "renewalNewsSummary": "Following Season 2's harrowing events, HBO has officially confirmed Season 3 covering the remainder of Part II.",
    "cast": [
      {
        "name": "Pedro Pascal",
        "role": "Joel Miller"
  ...
  },
  {
    ...
    "isNextWatch": true,
    "renewalState": "renewed",
    "renewalBadgeText": "Season 3 Streamed on Max • Renewed for S4",
    "nextSeasonNumber": 4,
    "renewalNewsSummary": "Mike White's third installment in Thailand has concluded; HBO has renewed the acclaimed satire for Season 4.",
    "cast": [
      {
        "name": "Carrie Coon",
        "role": "TBA"
  ...
  },
  {
    ...
    "isNextWatch": true,
    "renewalState": "in_production",
    "renewalBadgeText": "Season 3 Streamed on Prime • Season 4 Renewed",
    "nextSeasonNumber": 4,
  ...
  },
  {
    ...
    "isCurrentlyAiring": false,
    "renewalState": "concluded",
    "renewalBadgeText": "Complete Series • 2 Seasons on Disney+",
    "nextSeasonNumber": undefined,
    "renewalNewsSummary": "Season 2 concludes the prequel saga spanning four years leading directly into Rogue One.",
    "cast": [
      {
        "name": "Diego Luna",
        "role": "Cassian Andor"
  ...
  },
  {
    ...
    "isNextWatch": true,
    "renewalState": "in_production",
    "renewalBadgeText": "The Mandalorian & Grogu Feature Film in 2026",
    "renewalNewsSummary": "Next chapter expands into the big screen feature film The Mandalorian & Grogu directed by Jon Favreau.",
    "cast": [
      {
        "name": "Pedro Pascal",
  ...
  },
  {
    ...
    "isCurrentlyAiring": false,
    "renewalState": "renewed",
    "renewalBadgeText": "Season 2 Streamed on Peacock • Renewed",
    "nextSeasonNumber": 3,
    "renewalNewsSummary": "Rian Johnson and Natasha Lyonne return for another lineup of guest star murder mysteries.",
    "cast": [
      {
        "name": "Natasha Lyonne",
        "role": "Charlie Cale"
