      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3.5">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            {/* Bingecat Addon button */}
            <button
              id="btn-bingecat-addon"
              onClick={onOpenBingecatModal}
              title="Connect to Bingecat / Stremio Addon"
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-amber-950/40 hover:bg-amber-900/50 text-amber-300 border border-amber-500/40 text-xs font-semibold transition-all cursor-pointer whitespace-nowrap shadow-xs"
            >
              <Puzzle className="w-3.5 h-3.5 text-amber-400" />
              <span className="hidden sm:inline">Bingecat Addon</span>
            </button>
